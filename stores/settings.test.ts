...
describe("defaultSettings", () => {
  it("has correct default values", () => {
    expect(defaultSettings).toEqual({
      ...
      contextWordFilter: "all",
      contextShowEnglish: true,
      contextPlayAudio: false,
      fillBlankWordFilter: "all",
      fillBlankShowFurigana: false,
      fillBlankShowEnglish: true,
      fillBlankPlayAudio: false,
      showRomaji: false,
