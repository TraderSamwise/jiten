// Auto-generated from assets/starter-book.txt
// 夢十夜 (Ten Nights of Dreams) by 夏目漱石 (Natsume Soseki)
// Source: Aozora Bunko (https://www.aozora.gr.jp/)
export const STARTER_BOOK_CONTENT = `夢十夜
夏目漱石
...
　左右は青田《あおた》である。路《みち》は細い。鷺《さぎ》の影が時々｜闇《やみ》に差す。
...
「西へ行く日の、果《はて》は東か。それは本真《ほんま》か。東《ひがし》出る日の、御里《おさと》は西か。それも本真か。身は波の上。※［＃「楫のつくり＋戈」、第3水準1-84-66］枕《かじまくら》。流せ流せ」と囃《はや》している。舳《へさき》へ行って見たら、水夫が大勢寄って、太い帆綱《ほづな》を手繰《たぐ》っていた。
...
　庄太郎は必死の勇をふるって、豚の鼻頭を七日《なのか》六晩《むばん》叩《たた》いた。けれども、とうとう精根が尽きて、手が蒟蒻《こんにゃく》のように弱って、しまいに豚に舐《な》められてしまった。そうして絶壁の上へ倒れた。
